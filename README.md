...
A modular, graph-based dialogue framework for Unity with full localization support and editor integration.
...
4. Digite a URL: `https://github.com/Natteens/dialect.git`
5. Clique em **Add**
...
{
  "dependencies": {
    "com.example.dialect": "https://github.com/Natteens/dialect.git"
  }
}
```
